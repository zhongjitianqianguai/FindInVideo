...
def clip_video_silence(video_path, start_seconds, end_seconds):
    ...
    out_name = f'{video_stem}_{start_tag}-{end_tag}_silence{video_ext}'
...
def main():
    ...
    while True:
        ...
        clip_video_silence(video_path, start_seconds, end_seconds)
        print()
